const Todo = ({ task }) => {
  ...
  return (
    <div
      className={
        "w-full max-w-[27rem] bg-background border rounded px-4 py-2 hover:shadow-sm shadow-black group h-20"
      }
    >
      ...
      <div className="group-hover:flex border rounded-full w-fit bg-primary/10 cursor-pointer hidden text-xs font-semibold text-black/70">
